...
var CryptographyClient = /** @class */ (function () {
    ...
    CryptographyClient.prototype.setParentSpan = function (span, options) {
        ...
        if (span.isRecording()) {
            ...
            return __assign(__assign({}, options), { spanOptions: __assign(__assign({}, spanOptions), { parent: span.context(), attributes: __assign(__assign({}, spanOptions.attributes), { "az.namespace": "Microsoft.KeyVault" }) }) });
        }
        else {
            return options;
        }
