...
describe("Challenge based authentication tests", function () {
    var keyPrefix = "challengeAuth" + (env.KEY_NAME || "KeyName");
    var keySuffix;
    var client;
    var testClient;
    var recorder;
    ...
    it("Once authenticated, new requests should not authenticate again", function () {
        return __awaiter(this, void 0, void 0, function () {
            var sandbox, spy, keyName, keyNames, _i, keyNames_1, name_1, _a, keyNames_2, name_2;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        ...
                        return [3 /*break*/, 1];
                    case 4:
                        _a = 0, keyNames_2 = keyNames;
                        _b.label = 5;
                    case 5:
                        if (!(_a < keyNames_2.length)) return [3 /*break*/, 8];
                        name_2 = keyNames_2[_a];
    ...
    it("Authentication should work for parallel requests", function () {
        return __awaiter(this, void 0, void 0, function () {
            var keyName, keyNames, sandbox, spy, spyEqualTo, promises, _i, promises_1, promise;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        keyName = testClient.formatName(keyPrefix + "-" + this.test.title + "-" + keySuffix);
                        ...
                        promises = keyNames.map(function (name) {
                            var promise = client.createKey(name, "RSA");
                    ...
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, testClient.flushKey(promise.name)];
                    case 3:
                        _a.sent();
                        _a.label = 4;
                    case 4:
