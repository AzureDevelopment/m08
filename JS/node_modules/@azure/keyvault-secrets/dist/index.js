 ...
 * license information.
 * 
 * Azure KeyVault Secrets SDK for JavaScript - 4.0.4
 */
'use strict';
...
function parseWWWAuthenticate(wwwAuthenticate) {
    ...
    var keyValues = parts.reduce(function (parts, str) { return (str.match(/\w="/) ? tslib.__spreadArrays(parts, [str.split("=")]) : parts); }, []);
    // Then we transform these key-value pairs back into an object.
    var parsed = keyValues.reduce(function (result, _a) {
        var _b;
        var key = _a[0], value = _a[1];
        return (tslib.__assign(tslib.__assign({}, result), (_b = {}, _b[key] = value.slice(1, -1), _b)));
    }, {});
    return parsed;
}
/**
...
var SecretClient = /** @class */ (function () {
    ...
    SecretClient.prototype.setParentSpan = function (span, options) {
        ...
        if (span.isRecording()) {
            ...
            return tslib.__assign(tslib.__assign({}, options), { spanOptions: tslib.__assign(tslib.__assign({}, spanOptions), { parent: span.context(), attributes: tslib.__assign(tslib.__assign({}, spanOptions.attributes), { "az.namespace": "Microsoft.KeyVault" }) }) });
        }
        else {
            return options;
        }
